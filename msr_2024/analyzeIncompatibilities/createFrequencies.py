...
""" This version is different from the version in TrainedPTM/ in that it is applicable to the entire dataset of HF-GH license pairs, not just the trained PTM only dataset. """
""" TODO finish this version of the script """
